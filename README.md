# Набор шаблонов и инструментов для упрощения создания инструкций ПСОД
...
<details>
<summary> Размерность стоимости </summary>
<p>
        
### Code

```
Если СтрНайти(ВАЛЮТА, "руб") > 0 Тогда
    Результат = "руб."
ИначеЕсли СтрНайти(ВАЛЮТА, "дол") > 0 Тогда
    Результат = "дол.";
ИначеЕсли СтрНайти(ВАЛЮТА, "евр") > 0 Тогда
    Результат = "евро";
КонецЕсли;

Если ЗначениеЗаполнено(ПЕРИОД) Тогда
    Если СтрНайти(ПЕРИОД, "мес") > 0 Тогда
        Результат = Результат + "/мес.";
    ИначеЕсли СтрНайти(ПЕРИОД, "нед") > 0 Тогда
        Результат = Результат + "/нед.";
    ИначеЕсли СтрНайти(ПЕРИОД, "год") > 0 Тогда
        Результат = Результат + "/год";
    КонецЕсли;
КонецЕсли;
```
...
<details>
<summary> Общая площадь предложения </summary>
<p>
    
### Code

```
Если СтрНайти(НРег(ПЛОЩАДЬ_ЕДИЗМ), "сот") > 0 Тогда
    Результат = ПЛОЩАДЬ * 100;
ИначеЕсли НРег(ПЛОЩАДЬ_ЕДИЗМ )= "га" ИЛИ СтрНайти(НРег(ПЛОЩАДЬ_ЕДИЗМ), "гектар") > 0 Тогда
    Результат = ПЛОЩАДЬ * 10000;
Иначе
    Результат = ПЛОЩАДЬ;    
КонецЕсли;              
```
